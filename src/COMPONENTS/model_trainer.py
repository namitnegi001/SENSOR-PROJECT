...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            logging.info(f"splitting training and testing input and targt feature")
            ...
            model_report:dict=self.evaluate_models(X=x_train,y=y_train,models=self.modls)
